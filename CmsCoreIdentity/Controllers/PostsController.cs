...
using CmsCoreIdentity.Data;
using CmsCoreIdentity.Models;

namespace CmsCoreIdentity.Controllers
{
    public class PostsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CategoryId,Subject,Body,AuthorName,ImageUrl")] Post post)
        {
